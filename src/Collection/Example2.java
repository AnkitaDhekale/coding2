...
public static void main(String[] args) 
{
	...
	ArrayList al=new ArrayList(8);    //initial capacity=10
	 al.add("Rahul");
	 al.add("101");
	 al.add('A');
	 al.add(65.5f);
	...
	System.out.println(al);
	 ...
	 System.out.println(al);
	  ...
	  while(itr.hasNext())  // true false
	     ...
	     System.out.println("--print all info from arraylist using literator cursor--");
	  ...
	  for(int i=0;i<=al.size()-1;i++)
	  {
		...
		System.out.println("--print all data using foreach loop s1:al");  
